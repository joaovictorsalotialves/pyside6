...
class ButtonsGrid(QGridLayout):
    ...
    def _configLeftOp(self, text):
        displayText = self.display.text()  # Number _left
        self.display.clear()
        self.display.setFocus()

        # Se a pessoa clicou no operador sem ter nenhum número no display
        if not isValidNumber(displayText) and self._left is None:
            self._showError('Você não digitou nada.')
            return

        # Se hover o número da _left não fazer nada. Aguarda o número _right
